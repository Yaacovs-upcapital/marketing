          ...
          <div className="col-lg-4 col-md-12 col-sm-12" style={{ marginBottom: "2rem" }}>
            <MediaControlCard image={factoring}>
              <div >
                ...
                <a href="https://www.investopedia.com/terms/s/supplychain.asp" target="blank" className="btn btn-outline-primary" style={{ direction: "rtl" }}>{t('read_more')}</a>
              </div>
            </MediaControlCard>
          </div>
          <div className="col-lg-4 col-md-12 col-sm-12" style={{ marginBottom: "2rem" }}>
          ...
          <div className="col-lg-4 col-md-12 col-sm-12" style={{ marginBottom: "2rem" }}>
            <MediaControlCard image={supplyChain}>
              <div >
                ...
                <a href="https://www.investopedia.com/terms/s/supplychain.asp" target="blank" className="btn btn-outline-primary"  style={{direction:direction=='ltr'?'ltr':"ltr"}} >{t('read_more')}</a>
              </div>
            </MediaControlCard>
          </div>
          ...
          <div className="col-lg-4 col-md-12 col-sm-12" style={{ marginBottom: "2rem" }}>
            <MediaControlCard image={bizChart}>
              <div >
                ...
                <a href="https://www.bizportal.co.il/general/news/article/809483" style={{direction:direction=='ltr'?'ltr':"ltr"}}  target="blank" className="btn btn-outline-primary">{t('read_more')}</a>
              </div>
            </MediaControlCard  >
          </div>
          <div className="col-lg-4 col-md-12 col-sm-12" style={{ marginBottom: "2rem" }}>
            <MediaControlCard image={rashuiot}>
              <div >
                ...
                <a href="http://www.rashuiot.co.il/html5/ARCLookup.taf?_function=details&_ID=55766&did=1118&G=1118&SM=" style={{direction:direction=='ltr'?'ltr':"ltr"}}  target="blank" className="btn btn-outline-primary">{t('read_more')}</a>
              </div>
            </MediaControlCard>
          </div>
          ...
          <div className="col-lg-4 col-md-12 col-sm-12" style={{ marginBottom: "2rem" }}>
            <MediaControlCard image={ronChairmain}>
              <div >
                ...
                <a href="https://finance.walla.co.il/item/3477693"  style={{direction:direction=='ltr'?'ltr':"ltr"}} target="blank" className="btn btn-outline-primary">{t('read_more')}</a>
              </div>
            </MediaControlCard>
          </div>
